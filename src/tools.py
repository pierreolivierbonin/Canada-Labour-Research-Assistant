...
def retrieve_database(database_question,
    ...
    formatted_documents, formatted_documents_for_messages, metadata, ids, distances = reprioritize_docs(
        question_section_numbers, formatted_documents, formatted_documents_for_messages, metadata, ids, distances
    )
